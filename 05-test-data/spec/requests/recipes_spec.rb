...
RSpec.describe "Recipes", type: :request do
  describe "GET /index" do
    ...
    context "as an authenticated user" do
      it "displays recipes list to authenticacted user" do
  ...
  describe "DELETE /destroy" do
    context "as a guest" do
      it "redirects to sign-in" do
        ...
        expect { delete recipe_path(recipe) }.to_not change(Recipe, :count)
        expect(response).to redirect_to sign_in_path
      end
    end
    ...
    context "as the owner of this recipe" do
      it "deletes the recipe" do
        ...
        expect { delete recipe_path(recipe, as: user) }.to change(user.recipes, :count).by(-1)
    ...
    context "as a user who is not the owner of this recipe" do
      it "does not delete the recipe" do
        ...
        expect { delete recipe_path(recipe, as: user) }.to_not change(Recipe, :count)
        expect(response).to have_http_status(:not_found)
      end
    end
  end
